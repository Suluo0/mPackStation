...
export function OnboardingView({onCreate, onImport, onDemo}: {
  ...
  return (
    <div className="db-welcome-regions">
      <section className="db-hero db-hero-stage db-welcome-region-hero">
        <div className="db-hero-main">
          <div className="db-hero-copy">
          <span className="db-eyebrow">整合包工作台 / 01</span>
          <h1 className="db-hero-title"><span>从一个想法，</span><span>开始你的整合包</span></h1>
      ...
      <div className="db-onboard-grid db-onboard-grid-redraw db-welcome-region-entries">
        <div className="db-entry-row db-entry-row-redraw">
          <WorkbenchCard className="db-entry-card db-entry-card-feature" onClick={onCreate}>
            <span className="db-entry-icon db-entry-icon-create"><PlusOutlined/></span>
      ...
      <section className="db-starter-section db-welcome-region-starter" aria-labelledby="starter-title">
      ...
      <section className="db-capability-strip db-welcome-region-capability" aria-labelledby="capability-title">
